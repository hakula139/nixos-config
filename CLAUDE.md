...
│   ├── corp-hosts.nix               # Corp domain placeholder and derived internal hostnames
...
- Don't commit `data/corp-hosts.nix` with the real domain. The placeholder lives in git.
