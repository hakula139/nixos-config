...
That accounts for the ~170 lines of inline shell across the 22 `writeShellScript*` sites that carry a literal body. The other seven take a Nix expression, three of them a `builtins.readFile` of an adjacent `.sh` file.
