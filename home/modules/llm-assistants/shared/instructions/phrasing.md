...
- Put each Markdown paragraph on a single line and separate paragraphs with two line breaks, without hard-wrapping at column limits or giving each sentence its own line. Code blocks and tables are exempt.
