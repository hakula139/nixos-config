...
3. **"X, not Y" antithesis**: defining something by negating a strawman, e.g. "It's not just fast, it's reliable" or "This isn't about speed. It's about correctness." Reserve-for-real-misconception uses are fine.
